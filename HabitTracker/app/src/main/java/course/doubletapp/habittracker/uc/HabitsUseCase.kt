...
class HabitsUseCase {
    ...
    init {
        ...
        val habit2 = Habit("Two", "Description", PriorityHabit.MEDIUM, TypeHabit.BAD, 4, 5, -554234)
        val habit3 = Habit("Three", "Description", PriorityHabit.LOW, TypeHabit.BAD, 4, 5, -5534)
        val habit4 = Habit("Four", "Description", PriorityHabit.LOW, TypeHabit.GOOD, 4, 5, -12)
